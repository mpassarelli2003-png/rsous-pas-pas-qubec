        ...
        <div className="max-w-4xl w-full space-y-12 text-center">
          <div className="space-y-6 animate-fade-in">
            <div className="mx-auto h-24 w-24 rounded-3xl bg-primary flex items-center justify-center text-primary-foreground shadow-2xl shadow-primary/20 transform rotate-3 hover:rotate-0 transition-transform cursor-pointer">
              <span className="text-5xl font-black italic">R!</span>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-3 pt-8">
            <Card className="group relative overflow-hidden border-4 border-transparent hover:border-primary transition-all hover:scale-105 shadow-xl bg-white">
              ...
              <Link to="/select" className="p-8 h-full flex flex-col items-center gap-4 text-center">
                <div className="h-16 w-16 rounded-full bg-primary/10 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-colors">
                  <BookOpen className="h-8 w-8" />
                </div>
                <h3 className="text-xl font-bold">Commencer un problème</h3>
            ...
            <Card className="group relative overflow-hidden border-4 border-transparent hover:border-accent transition-all hover:scale-105 shadow-xl bg-white">
              ...
              <Link to="/progress" className="p-8 h-full flex flex-col items-center gap-4 text-center">
                <div className="h-16 w-16 rounded-full bg-accent/10 flex items-center justify-center text-accent group-hover:bg-accent group-hover:text-white transition-colors">
                  <BarChart2 className="h-8 w-8" />
                </div>
                <h3 className="text-xl font-bold">Mes progrès</h3>
            ...
            <Card className="group relative overflow-hidden border-4 border-transparent hover:border-yellow-500 transition-all hover:scale-105 shadow-xl bg-white">
              ...
              <Link to="/select" search={{ examMode: true }} className="p-8 h-full flex flex-col items-center gap-4 text-center">
                <div className="h-16 w-16 rounded-full bg-yellow-500/10 flex items-center justify-center text-yellow-600 group-hover:bg-yellow-500 group-hover:text-white transition-colors">
          ...
          <div className="text-muted-foreground text-sm flex items-center justify-center gap-2 pt-4">
