...
export function Step3Knowledge({ problem, onUpdate, savedData, highlightedTokenIds = [] }: Step3KnowledgeProps) {
  ...
  const handleMoneyDrawingSave = (dataUrl: string, height: number, objects?: any[]) => {
    const nextWorkspace = { ...workspace, moneyDrawing: dataUrl, moneyDrawingHeight: height, moneyObjects: objects || workspace.moneyObjects || [] };
